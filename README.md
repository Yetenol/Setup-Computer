...
| [Signal](instructions/communication.md#install-signal)                       |                                                              |                            [Web](https://signal.org/en/download/)                            | `winget install -e OpenWhisperSystems.Signal --accept-package-agreements`                                                         |
