...
| [Zoom](instructions/communication.md#install-zoom)                           |                        &#128279;                        |                               [Web](https://zoom.us/download)                                | `winget install -e Zoom.Zoom` <br> `winget install -e XP99J3KP4XZ4VV --accept-package-agreements`              |
...
| App ➔ Instructions                                           |                          Store                          |                        Source                         | Install command                                                                                                 |
| ------------------------------------------------------------ | :-----------------------------------------------------: | :---------------------------------------------------: | --------------------------------------------------------------------------------------------------------------- |
| [Windows Terminal](instructions.md#install-windows-terminal) | [MS](https://www.microsoft.com/store/apps/9n0dx20hk701) |                                                       | `winget install -e 9N0DX20HK701 --accept-package-agreements` <br> `winget install -e Microsoft.WindowsTerminal` |
