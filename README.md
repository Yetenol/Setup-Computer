...
| App ➔ Instructions                                             |                        Store                        |                                               Source                                               | Install command                                                                                                     |
| -------------------------------------------------------------- | :-------------------------------------------------: | :------------------------------------------------------------------------------------------------: | ------------------------------------------------------------------------------------------------------------------- |
| _[Gitkraken](instructions.md#gitkraken)_                       |                                                     |                        [Web](https://www.gitkraken.com/download/windows64)                         | `winget install -e Axosoft.GitKraken`                                                                               |
| _[KeePass](instructions.md#keepass)_                           |                                                     |                             [Web](https://keepass.info/download.html)                              | `winget install -e DominikReichl.KeePass`                                                                           |
